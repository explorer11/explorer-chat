...
public class ConnectedUsersTest {
    ...
    public void shouldAdd() throws IOException {
        ...
        connectedUsers.add(user1, Mockito.mock(OutputStream.class));
    ...
    public void shouldAddTwoElements() throws IOException {
        ...
        connectedUsers.add(user1, Mockito.mock(OutputStream.class));
        connectedUsers.add(user2, Mockito.mock(OutputStream.class));
    ...
    public void shouldNotAddSameUserTwice() throws IOException {
        final String user1 = "user1";
        final boolean added = connectedUsers.add(user1, Mockito.mock(OutputStream.class));
        assertThat(added).isTrue();
        assertThat(connectedUsers.getUsersNames()).containsExactly(user1);

        final boolean addedTwice = connectedUsers.add(user1, Mockito.mock(OutputStream.class));
    ...
    public void shouldGiveOutputs() throws IOException {
        ...
        connectedUsers.add(user1, output1);
        connectedUsers.add(user2, output2);
